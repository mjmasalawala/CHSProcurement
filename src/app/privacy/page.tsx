...
const SECTIONS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "We use your information to operate the ProSoc platform: matching requirements with eligible vendors, facilitating quotations and approvals, sending transactional notifications (by email and SMS), verifying registrations, and maintaining a permanent, auditable record of procurement activity on the platform.",
  },
  {
