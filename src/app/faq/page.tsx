  ...
  return (
    <main className="flex flex-1 flex-col items-center gap-6 px-6 py-16">
      <div className="flex w-full max-w-2xl flex-col gap-8">
        <div>
          <h1 className="text-[28px] font-bold text-text-primary">Frequently Asked Questions</h1>
          <p className="mt-2 text-[15px] text-text-secondary">
            Answers for societies and society committee members getting started on ProSoc.
          </p>
        </div>
